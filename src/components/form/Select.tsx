	...
	const selectVariants: {
		...
		solid: {
			general: classNames(
				...
				'bg-zinc-100 dark:bg-zinc-800', // Background color for light and dark modes
				'text-black dark:text-white', // Text color for light and dark modes
				// Hover states
				...
				// Adding transition for background and text color
