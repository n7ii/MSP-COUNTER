...
const SearchPartial = () => {
	...
	const list = [
		...Object.values(appPages.customerPage.subPages).map((i) => ({
			...i,
			category: 'App',
		})),
		...Object.values(appPages.settingPage.subPages).map((i) => ({
			...i,
			category: 'Setting',
		})),
		...Object.values(appPages.reportPages.subPages).map((i) => ({
			...i,
			category: 'Report',
		})),
		...Object.values(appPages.logPages.subPages).map((i) => ({
			...i,
			category: 'Log',
		})),
