				...
				<div className='pl-44 pt-16'>
					<div className='space-y-1 text-xs text-black'>
						<div className='flex gap-2'>
							<span className='whitespace-nowrap font-light'>Account Name:</span>
						...
						<div className='flex gap-2'>
							<span className='whitespace-nowrap font-light'>Account number:</span>
							<span className='font-light'>{customerDetail?.accountNo || 'N/A'}</span>
						</div>

						<div className='flex gap-2'>
							<span className='whitespace-nowrap font-light'>Account Address:</span>
						...
						<div className='flex gap-2'>
							<span className='font-light'>Account Type:</span>
						...
						<div className='flex gap-2'>
							<span className='font-light'>Account Status:</span>
							<span className='font-light'>
